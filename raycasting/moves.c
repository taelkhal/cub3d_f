...
/*   Updated: 2024/01/01 15:10:21 by taelkhal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	move_down(t_game *game, int check)
{
    ...
    if (game->map->map[(int)(game->player->y - game->player->pdy * P_SPEED) / game->size_px_map][(int)(game->player->x - game->player->pdx * P_SPEED) / game->size_px_map] == '0')
    {
        game->player->x = game->player->x - game->player->pdx;
        game->player->y = game->player->y - game->player->pdy;
    }
...
void	move_right(t_game *game)
{
    ...
    if (new_angle > 360.0)
        new_angle -= 360.0;
    if (game->map->map[(int)(game->player->y + sin(degtorad(new_angle)) * P_SPEED) / game->size_px_map][(int)(game->player->x + cos(degtorad(new_angle)) * P_SPEED) / game->size_px_map] != '1')
    {
...
void	move_left(t_game *game)
{
    ...
    [(int)(game->player->x + cos(degtorad(new_angle)) * P_SPEED) / game->size_px_map] != '1')
    {
        game->player->x = game->player->x + cos(degtorad(new_angle)) * 5;
        game->player->y = game->player->y + sin(degtorad(new_angle)) * 5;
    }
